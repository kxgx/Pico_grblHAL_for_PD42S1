...
#define BOARD_PICO_PD42S1      // Pi Pico2 W with custom pin assignments
//#define BOARD_MY_MACHINE      // Add my_machine_map.h before enabling this!

// Configuration
// Uncomment to enable.
// ONLY USB and BLUETOOTH serial enabled - all other features disabled!

#ifndef USB_SERIAL_CDC
#define USB_SERIAL_CDC          1 // Serial communication via native USB.
#endif
#define BLUETOOTH_ENABLE        1 // Enable Pico W/Pico2 W onboard Bluetooth (SPP over GATT).
// Spindle selection:
...
#define PROBE_ENABLE            0 // Disable probe input (not configured in pin map)
